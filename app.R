...
parkland <- read.csv("./data/centroids_ppark")
centroids_sp <- SpatialPointsDataFrame(coords = parkland[,2:3], data = parkland, proj4string = utm15nCRS)
                    ...
                    dashboardBody(
                      tabItems(
                        ...
                        tabItem(
                          ...
                          tags$p(tags$strong("Total grasslands"), "is the number of remnant prairie patches in your network."),
                          tags$br(),
                          ...
                          tags$p(tags$strong("Number of components"), "quantifies how many discrete sets of patches are connected to each other in the network. A more connected 
                                 network will have fewer components within it, as this means that many patches are connected to one another."),
                          tags$br(),
                          ...
                          tags$p(tags$strong("Maximum component size"), "is the number of patches that make up the largest component in the network."),
                          tags$br(),
                          ...
                          tags$p(tags$strong("Isolated fragments"), "is the number of patches that are not connected to any other patch."),
                          tags$br(),
                          ...
                          tags$p(tags$strong("Total grasslands:"), "9", align = "left"),
                        ...
                        tabItem(
                          ...
                          tags$p(tags$a(href="https://www.wildflower.org/plants/result.php?id_plant=denu2", "Nuttal's Larkspur"), tags$i("(Delphinium nuttallianum)"), 
                                 ": The pollen of these larkspurs has been measured to move only", tags$strong("1 meter"), "on average (Price & Waser 1979)."),
                          tags$p(tags$a(href="https://www.minnesotawildflowers.info/flower/golden-alexanders", "Golden Alexander"), tags$i("(Zizia aurea)"),
                                 ": The exact dispersal distances of forbs (herbaceous, flowering plants) aren't currently well quantified. However, we have found Golden Alexanders to likely disperse", 
                                 tags$strong("under 50 meters"), "(Sperry et al. in review)."),
                          tags$p(tags$a(href="https://www.minnesotawildflowers.info/flower/narrow-leaved-purple-coneflower", "Narrow-leaved purple coneflower"), tags$i("(Echinacea angustifolia)"),
                                 ...
                                 tags$strong(" 1 meter"), "(Ison et al. 2014)."),
                          tags$p(tags$a(href="https://en.wikipedia.org/wiki/Western_harvest_mouse", "Western Harvet Mouse"), tags$i("(Reithrodontomys megalotis)"),
                                 ": In one study, the median distance male mice taveled from their home sites was found to be", tags$strong("33.7 meters"), "(Skupiski, 1995)."),
                          ...
                          tags$p(tags$a(href="https://www.allaboutbirds.org/guide/Dickcissel/lifehistory#", "Dickcissel"), tags$i("(Spiza Americana)"),
                                 ...
                                 to start a new nest (Walk et al. 2004)"),
                          tags$p(tags$a(href="https://en.wikipedia.org/wiki/Bobolink", "Bobolink"), tags$i("(Dolichonyx oryzivorus)"),
                                 ...
                                 "(Fajardo et al. 2009) from their birth site to breeding site."),
                          ...
                          tags$p(tags$a(href="https://en.wikipedia.org/wiki/Red_fox", "Red Fox"), tags$i("(Vulpes vulpes)"),
                                 ...
                                 tags$strong("31,000 meters"), "on average from their home sites (Storm et al. 1996)."),
                          tags$p(tags$a(href="https://en.wikipedia.org/wiki/Burrowing_owl", "Burrowing Owl"), tags$i("(Athene cunicularia)"),
                                 ...
                                 tags$strong("2,802 meters"), "(on average) from their nests (Catlin & Rosenberg 2008).")
                          ),
                        ...
                        tabItem(
                          ...
                          tags$p("This app is meant to facilitate exploration of connectivity in Minnesota's 
                                 grasslands. By clicking on a county you see its current network of remnant 
                          ...
                          tags$p(icon("fas", class = "fas fa-seedling", lib = "font-awesome")),
                          tags$p("To learn more about our research visit", tags$a(href="https://allisonkshaw.weebly.com/", "our lab's website.") ),
                          tags$p(tags$i("App created by Katie Sperry - prairieconnectivity@gmail.com")),
                          tags$p(tags$i("Last updated 06/14/2019"))
                          )
                          )
...
server <- function(input, output) {
  ...
  metricsUtility <- function(distanceMatrix, dispersalDistance){
    ...
    network_results <- data.frame(no_grasslands,no_comp,round(avgsize,digits=4),maxcomp,round(trans,digits=4),isolated) %>% 
      'colnames<-'(c("Total number of grasslands:","Number of components:","Avg patches per component:","Max component size:","Transitivity:","Number of isolated patches:"))
  ...
  observe({
    ...
    if(isTRUE((Log$add[i])=="0")){
      ...
      if(isTRUE(Log$add[i]=="1")){
        #print("observing map for restorations")
        leafletProxy("map") %>% 
          clearGroup("selected_area") %>% 
          clearGroup("selected_grasses") %>% 
          clearGroup("drawn_connections") %>% 
  ...
  observe({
    #print("observing universal metrics logs")
